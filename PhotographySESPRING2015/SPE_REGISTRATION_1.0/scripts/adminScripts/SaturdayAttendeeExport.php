...
// set output filename 
$filename = $serverRoot . "/outputFiles/SaturdayAttendees_" . date("Y") . ".csv";
...
$query = "SELECT CONCAT(Lname, ', ', Fname), Email, Pref1, Pref2, Pref3, Pref4, Pref5, Pref6, Pref7, Pref8, Pref9,
				Pref10, Pref11, Pref12, Pref13, Pref14, Pref15, Pref16, Pref17, Pref18, Pref19, Pref20 FROM PROFESSIONAL";
