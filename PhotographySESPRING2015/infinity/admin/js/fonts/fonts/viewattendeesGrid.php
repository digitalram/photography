...
$result = mysql_query("SELECT COUNT(*) AS count FROM attendees"); 
...
$SQL = "SELECT First_Name, Last_Name FROM attendees ORDER BY $sidx $sord LIMIT $start , $limit"; 
